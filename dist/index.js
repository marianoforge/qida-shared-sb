...
const Button = (_a) => {
    ...
    return (jsxRuntimeExports.jsx("button", Object.assign({ className: buttonClasses }, props, { children: children })));
};

// Exportar tokens de diseño
// Función de configuración (opcional)
function configureDesignTokens(config = {}) {
    // Implementar lógica de configuración si es necesario
    console.log("Design tokens configured with:", config);
}

exports.Button = Button;
exports.configureDesignTokens = configureDesignTokens;
